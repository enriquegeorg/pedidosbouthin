...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/pedidosbouthin$1.0.0/src/app/views/vagas/lista/dados/ClientesRecusa.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<header class=\"cabecalhoPrincipal\"><div class=\"container\"><div class=\"row align-items-center\"><div class=\"col-4\"><h1 class=\"logo\"><img src=\"/estatico/imagens/logo-cabecalho.png\" alt=\"Hunter Co\" height=\"35px\" width=\"auto\"></h1></div><div class=\"cabecalhoPrincipal-navegacao col-8\"><a href=\"#\" class=\"login\"><i class=\"fas fa-sign-in-alt\"></i>Login</a></div></div></div></header><main class=\"conteudoPrincipal\"><div class=\"container\"><h1> Dados qualitativos e quantitativos </h1><h3> Clientes que reijeitaram todos os candidatos </h3><table id=\"clientes\" class=\"table table-striped table-hover\"><thead class=\"thead-dark\"><tr><td>Nome do Cliente</td><td>Quantidade de Rejeições</td></tr></thead>");

  var for__25 = 0;

  marko_forEach(data.clientesRecusa, function(cliente) {
    var keyscope__26 = "[" + ((for__25++) + "]");

    out.w("<tr id=\"cliente_" +
      marko_escapeXmlAttr(cliente.cliente) +
      "\"><td>" +
      marko_escapeXml(cliente.clientes_recusaram_todos) +
      "</td><td>" +
...
marko_template.meta = {
    id: "/pedidosbouthin$1.0.0/src/app/views/vagas/lista/dados/ClientesRecusa.marko",
    tags: [
