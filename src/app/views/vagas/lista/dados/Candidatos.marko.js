...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/pedidosbouthin$1.0.0/src/app/views/vagas/lista/dados/Candidatos.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<header class=\"cabecalhoPrincipal\"><div class=\"container\"><div class=\"row align-items-center\"><div class=\"col-4\"><h1 class=\"logo\"><img src=\"/estatico/imagens/logo-cabecalho.png\" alt=\"Hunter Co\" height=\"35px\" width=\"auto\"></h1></div><div class=\"cabecalhoPrincipal-navegacao col-8\"><a href=\"#\" class=\"login\"><i class=\"fas fa-sign-in-alt\"></i>Login</a></div></div></div></header><main class=\"conteudoPrincipal\"><div class=\"container\"><h1> Dados qualitativos e quantitativos </h1><h3> Candidatos mais rejeitados </h3><table id=\"candidatos\" class=\"table table-striped table-hover\"><thead class=\"thead-dark\"><tr><td>Candidato</td><td>Número de Rejeições</td></tr></thead>");
  ...
  marko_forEach(data.candidatos, function(candidato) {
    ...
    out.w("<tr id=\"candidato_" +
      marko_escapeXmlAttr(candidato.candidato) +
      "\"><td>" +
      marko_escapeXml(candidato.nome_candidato) +
      "</td><td>" +
      marko_escapeXml(candidato.qtd_rejeicoes) +
      "</td></tr>");
  });
...
marko_template.meta = {
    id: "/pedidosbouthin$1.0.0/src/app/views/vagas/lista/dados/Candidatos.marko",
    tags: [
