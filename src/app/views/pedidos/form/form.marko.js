...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/pedidosbouthin$1.0.0/src/app/views/pedidos/form/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<form action=\"/pedidos/form\" method=\"post\">");

  if (data.pedido.id) {
    out.w("<div><input type=\"hidden\" name=\"_method\" value=\"PUT\"><input type=\"hidden\" id=\"id\" name=\"id\" value=\"" +
      marko_escapeXmlAttr(data.pedido.id) +
      "\" class=\"form-control\"></div>");
  }

  out.w("<div class=\"form-group\"><label for=\"idempresa\">Empresa:</label><input type=\"text\" id=\"idempresa\" name=\"idempresa\" value=\"" +
    marko_escapeXmlAttr(data.pedido.idempresa) +
    "\" placeholder=\"selecione a empresa que fará o pedido\" class=\"form-control\"></div><div class=\"form-group\"><label for=\"produtos\">Produtos:</label><input type=\"text\" id=\"produtos\" name=\"produtos\" value=\"" +
    marko_escapeXmlAttr(data.pedido.produtos) +
    "\" class=\"form-control\"></div><div class=\"form-group\"><label for=\"valor\">Valor:</label><input type=\"text\" id=\"valor\" name=\"valor\" value=\"" +
    marko_escapeXmlAttr(data.pedido.valor) +
    "\" class=\"form-control\"></div><div class=\"form-group\"><label for=\"desconto\">Desconto:</label><input type=\"text\" id=\"desconto\" name=\"desconto\" value=\"" +
    marko_escapeXmlAttr(data.pedido.desconto) +
    "\" class=\"form-control\"></div><div class=\"form-group\"><label for=\"dataentrega\">Prazo de entrega:</label><input type=\"text\" id=\"dataentrega\" name=\"dataentrega\" value=\"" +
    marko_escapeXmlAttr(data.pedido.dataentrega) +
    "\" class=\"form-control\"></div><div class=\"form-group\"><label for=\"situacao\">Situação:</label><input type=\"text\" id=\"situacao\" name=\"situacao\" value=\"" +
    marko_escapeXmlAttr(data.pedido.situacao) +
...
marko_template.meta = {
    id: "/pedidosbouthin$1.0.0/src/app/views/pedidos/form/form.marko",
    tags: [
